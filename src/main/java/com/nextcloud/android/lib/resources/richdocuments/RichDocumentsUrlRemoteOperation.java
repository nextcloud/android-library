 ...
 */
public class RichDocumentsUrlRemoteOperation extends RemoteOperation<String> {

    private static final String TAG = RichDocumentsUrlRemoteOperation.class.getSimpleName();
    ...
    public RichDocumentsUrlRemoteOperation(String fileId) {
        this.fileId = fileId;
    }
