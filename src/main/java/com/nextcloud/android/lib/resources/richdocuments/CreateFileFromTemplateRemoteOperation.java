 ...
 */
package com.nextcloud.android.lib.resources.richdocuments;
...
public class CreateFileFromTemplateRemoteOperation extends RemoteOperation<String> {
    private static final String TAG = CreateFileFromTemplateRemoteOperation.class.getSimpleName();
    ...
    public CreateFileFromTemplateRemoteOperation(String path, int templateId) {
        this.path = path;
