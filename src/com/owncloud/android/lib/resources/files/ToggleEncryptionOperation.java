...
public class ToggleEncryptionOperation extends RemoteOperation {

    private static final String TAG = ToggleEncryptionOperation.class.getSimpleName();
     ...
     * Constructor
     */
    public ToggleEncryptionOperation(String localId, String remotePath, boolean encryption) {
