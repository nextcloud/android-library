    ...
    constructor(
        ...
        private fun failure(e: Exception): RemoteOperationResult<Any> =
            RemoteOperationResult<Any>(e).also {
                Log_OC.e(TAG, "Remove $remotePath : ${it.logMessage}", e)
            }

        companion object {
            private val TAG: String = RemoveAlbumFileRemoteOperation::class.java.simpleName
        }
    }
