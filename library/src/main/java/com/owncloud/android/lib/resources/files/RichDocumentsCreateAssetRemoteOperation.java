...
public class RichDocumentsCreateAssetRemoteOperation extends LegacyRemoteOperation {
    private static final String TAG = RichDocumentsCreateAssetRemoteOperation.class.getSimpleName();
    ...
    public RichDocumentsCreateAssetRemoteOperation(String path) {
        this.path = path;
    }
