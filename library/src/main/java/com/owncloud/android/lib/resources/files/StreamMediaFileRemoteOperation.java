...
public class StreamMediaFileRemoteOperation extends LegacyRemoteOperation {
    private static final String TAG = StreamMediaFileRemoteOperation.class.getSimpleName();
    ...
    public StreamMediaFileRemoteOperation(long fileID) {
        this.fileID = fileID;
    }
